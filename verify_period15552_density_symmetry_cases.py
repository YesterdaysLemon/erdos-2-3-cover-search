#!/usr/bin/env python3
"""Replay the 18-case symmetry split for period-15552 density obstructions."""
...
def main() -> int:
    ...
    for c19 in range(3):
        for c37 in range(3):
            ...
            if len(solutions) != 1:
                raise AssertionError("order-3 anchors do not normalize uniquely")
        ...
        for c37 in range(3):
            ...
            for c73 in range(3):
                ...
                for c97 in range(4):
                    ...
                    for c109 in range(9):
                        normalized109 = shifted(rows[109], c109, *shift3)
                        ...
                        for c15121 in range(9):
                            ...
                            if normalized73 == 2:
                                ...
                                normalized15121 = (-normalized15121) % 9
                            canonical.add(
                                (
                                    orbit,
                                    normalized109 % 3,
    ...
    audit = {
        ...
        "scope": (
            "all phase assignments of the 31 rows in the supplied "
            "period-15552 component core"
        ),
    }
